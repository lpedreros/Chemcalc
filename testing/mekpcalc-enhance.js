// mekpcalc-enhance.js
//
// MEKP Calculator — Magic Patterns audit pass 2 (Aug 2026). Page-scoped
// presentation logic plus one small compatibility shim, all built
// strictly on top of calculateMEKP()'s existing output. Nothing here
// performs MEKP math, and nothing here touches mekscript.js.
//
//   1. Temperature-unit toggle shim — mekscript.js reads
//      document.getElementById('tempUnit').value to know the current
//      unit ("fahrenheit" | "celsius"). The visible control is now a
...
//      already writes (same extraction approach as mekpcalc-print.js).
...
(function () {
  ...
  // Breakpoints are the LIVE SITE's own (60 / 65.6 / 75 / 85°F), not the
  // mockup's (60/70/80/90). Input is converted to °F first when the
  // toggle is set to Celsius.
  ...
  function updateSliderGradient() {
    ...
    slider.style.setProperty('--mekp-slider-fill', pct + '%');
  }
